<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.ArrayList" import="jung.DessertList" isELIgnored="false" %>
...
<body>
	...
	<div class="p-5 mb-4 bg-body-tertiary rounded-3">
		...
		String name=request.getParameter("name");
				DessertRepository create=id.getInstance();
			DessertList sell= create.getSellByName(name);
		%>
		<div class="all">
