<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8" import="java.util.ArrayList" import="jung.DessertList" import="jung.Fileupload_process" isELIgnored="false" %>
...
<article class="article">
	...
	<div class="align-itmes-md-stretch text-center" id="dessertsection">
		...
		DessertRepository create = DessertRepository.getInstance();
			ArrayList<DessertList> ListOfDessert = create.getAllSell();
		%>
	<div class="row align-items-md-stretch text-center">
		<%
		for (int i = 0; i < ListOfDessert.size(); i++) {
			DessertList sell = ListOfDessert.get(i);
		%>
